import type { Workflow, WorkflowVersion, CFConnection, WorkflowRun } from './types.js'
...
export interface DatabaseAdapter {
  ...
  updateWorkflow(id: string, data: { name?: string; description?: string; currentVersionId?: string }): Promise<Workflow>
