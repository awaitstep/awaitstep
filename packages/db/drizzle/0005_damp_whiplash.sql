...
CREATE UNIQUE INDEX `idx_env_vars_user_name` ON `env_vars` (`user_id`,`name`);--> statement-breakpoint
CREATE INDEX `idx_env_vars_user_id` ON `env_vars` (`user_id`);--> statement-breakpoint
...
ALTER TABLE `workflows` ADD `env_vars` text;